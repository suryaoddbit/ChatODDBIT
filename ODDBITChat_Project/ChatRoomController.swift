...
class ChatRoomController: UIViewController, UINavigationControllerDelegate {
    ...
    func configureDatabase() {
        ...
        _refHandle = ref.child("messages-room").observe(.childAdded) { (snapshot: FIRDataSnapshot)in
    ...
    deinit {
        ref.child("messages-room").removeObserver(withHandle: _refHandle)
    ...
    func sendMessage(data: [String:String]) {
        ...
        ref.child("messages-room").childByAutoId().setValue(mdata)
    }
